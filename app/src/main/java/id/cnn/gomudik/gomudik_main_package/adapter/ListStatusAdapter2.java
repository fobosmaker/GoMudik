...
public class ListStatusAdapter2 extends RecyclerView.Adapter<ListStatusAdapter2.ViewHolder> {
    private List<ListStatus.Data> list;
    private StatusActivity mContext;
    private Integer last_row;

    public ListStatusAdapter2(List<ListStatus.Data> list, Context mContext, Integer limit){
        this.list = list;
        this.mContext = (StatusActivity) mContext;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final ListStatus.Data listItems = list.get(position);
        ...
        String userId = mContext.getCurrUserId();
        if(userId != null){
            if(userId.equals(listItems.getId_users())){
                holder.buttonStatusAction.setVisibility(View.VISIBLE);
                ...
                holder.buttonStatusAction.setVisibility(View.GONE);
            }
        } else {
            holder.buttonStatusAction.setVisibility(View.GONE);
        }
        ...
        holder.status_comment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mContext.showStatusComment(listItems);
            }
        });
    }
