...
public class GoMudikNewsAdapter extends RecyclerView.Adapter<GoMudikNewsAdapter.ViewHolder> {
    private List<GetNews.Data> list;
    private Context mContext;

    public GoMudikNewsAdapter(List<GetNews.Data> list, Context mContext){
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_gomudiknews,parent,false);
