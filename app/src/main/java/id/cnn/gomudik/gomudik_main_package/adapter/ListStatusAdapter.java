...
public class ListStatusAdapter extends RecyclerView.Adapter<ListStatusAdapter.ViewHolder> {
    private Response<ListStatus> list;
    private StatusActivity mContext;
    private Integer last_row;

    public ListStatusAdapter(Response<ListStatus> list, Context mContext, Integer limit){
        this.list = list;
